...
display3:
    ...
    bsf PORTD, 2 ;Activamos ((PORTD) and 07Fh), 2
...
display4:
    ...
    movwf PORTC ;Lo movemos al PORTD
    bsf PORTD, 3 ;Activamos ((PORTD) and 07Fh), 3
...
display5:
    ...
    movwf PORTC ;Lo movemos al PORTD
    bsf PORTD, 4 ;Activamos ((PORTD) and 07Fh), 4
...
display6:
    ...
    movwf PORTC ;Lo movemos al PORTD
    bsf PORTD, 5 ;Activamos ((PORTD) and 07Fh), 5
...
display7:
    ...
    movwf PORTC ;Lo movemos al PORTD
    bsf PORTD, 6 ;Activamos ((PORTD) and 07Fh), 6
...
display8:
    ...
    movwf PORTC ;Lo movemos al PORTD
    bsf PORTD, 7 ;Activamos ((PORTD) and 07Fh), 7
...
modo1: ;Modificamos el valor del semaforo 1
    ...
    btfss PORTB, 1 ;Al presionar ((PORTB) and 07Fh), 1 incrementamos la variable
    call incremento

    btfss PORTB, 2 ;Al presionar ((PORTB) and 07Fh), 2 decrementamos la variable
    call decremento
...
modo4: ;Aceptamos o rechazamos los cambios
    ...
    btfss PORTB, 1 ;Si presionamos ((PORTB) and 07Fh), 1 aceptamos los cambios
    goto acepto

    btfss PORTB, 2 ;Si presionamos ((PORTB) and 07Fh), 2 rechazamos los cambios
    goto rechazo
...
config_IO:
    ...
    bsf WPUB, 2 ;Habilitar el pullup interno en ((PORTB) and 07Fh), 2
...
config_int:
    ...
    bsf ((INTCON) and 07Fh), 6 ;Habilitar las interupciones perifericas
...
config_TMR1:
    ...
    bsf ((T1CON) and 07Fh), 4 ;Prescaler (11) 1:8
